...
var Painting = function() {
	...
	this.initPainting();
	var colorpicker = this.js.querySelector(".colorpicker").children;
	var _g = 0;
	while(_g < colorpicker.length) {
		var i = [colorpicker[_g]];
		++_g;
		i[0].onclick = (function(i) {
			return function() {
				_gthis.pen.setPenColor(i[0].innerText);
			};
		})(i);
	}
...
Painting.prototype = {
	...
	,initPainting: function() {
		...
		res.innerText = "" + this.width + "x" + this.height;
	}
